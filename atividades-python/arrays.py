...
music_store_items = ["Violão", "Saxofone", "Teclado", "Bateria", "Guitarra"]
print(music_store_items)

relatives_and_friends_date_of_birth = [1999, 1976, 1973, 1993, 2007]
print(relatives_and_friends_date_of_birth)